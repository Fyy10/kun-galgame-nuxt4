<!-- @generated by nextmoe-docs docs:sync — DO NOT EDIT HERE.
     Source of truth: https://github.com/next-moe/nextmoe-infra/blob/main/docs/integration/oauth/oauth-integration-guide.md
     Edit the source, then run `pnpm docs:sync` from nextmoe-docs. -->
