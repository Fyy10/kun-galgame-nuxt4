...
description: '本指南汇总了多个优质 Galgame 资源网站，按推荐等级分为 SSS、T0 到 T3 多个级别。文章首推 “Galgame 网站 Wiki” 作为最全面的资源索引平台。T0 级别包括 Nyaa，是最全面的 Galgame 资源站。T1 级别推荐 Anime-Sharing（AS 论坛）和 绯月论坛（KF），前者资源丰富，后者为中文 Galgame 交流的核心。T2 级别涵盖网盘下载站，如 zi0.cc。特殊站点包括 Moyu.moe（补丁下载）和 Telegram 群组（如黄油联盟 bot），提供自动化搜索服务。此外，Kungal.com 是开源、开放、无门槛的独特站点。'
...
这是我们的网站，我们的网站是一个特殊的网站，其特殊的**手写、开源、无门槛、完全免费**性质是当前任何一个网站都比不上的, **我们的网站不是 Galgame 资源站**
